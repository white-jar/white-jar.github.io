...
pubDate: 2012-12-24
description: '使用者認證的WCF服務—wsHttpBinding繫結'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
使用者認證的WCF服務—wsHttpBinding繫結

目錄：[WCF 自訂使用者帳號/密碼篇](http://www.dotblogs.com.tw/nethawk/archive/2012/12/23/85885.aspx)

**1. wsHttpUserAuth.filehost 專案—檔案模式**

在方案中加入一個新網站﹐選用**檔案系統**來建罝這個專案﹐將vs自動產生的Service.svc﹑Service.cs﹑IService.cs全部刪除﹐然後參考4.3.1所建立的MyProducts.lib.dll。然後在這個專案下新增一個文字檔﹐將檔名改為MyProducts.**svc**。整個檔案結構看起來應該如下。

[![image](images/85924-01.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_2.png)
...
[![image](images/85924-02.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_4.png)
...
[![image](images/85924-03.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_6.png)

[![image](images/85924-04.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_8.png)
...
**[![image](images/85924-05.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_10.png)**
...
**在行為中主要增加了憑證的設定﹐增加了serviceCredentials中的相關設定。**
...
**WCF設定完後先開啟瀏灠器執行 http://localhost:56622/wsHttpUserAuth.filehost/MyProducts.svc 測試是否沒有問題﹐若沒問題則可以先參考以下1.2.2 在client端要如何調用。**
...
**[![image](images/85924-06.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_12.png)**
...
**[![image](images/85924-07.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_14.png)**
...
**將這個寫子的WCF複製到WIN 2008 Server上﹐假設路徑為 C:\Website\WCFSample\wsHttpUserAuth.webhot﹐在IIS上建立一個站台WCFSample指向C:\Website\WCFSample﹐port設定為85﹐IIS 7.X會自動幫這個站台建立一個應用程式集區名稱為WCFSample。在這個站台之下建立一個應用程式名稱為wsHttpUserAuth.webhost﹐將路徑指向C:\Website\WCFSample\wsHttpUserAuth.webhot。**

**[![image](images/85924-08.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_16.png)**

**接著必須憑證檔安裝至Server上。可以將本機上建立的測試用憑證檔匯出﹐然後在Server上做匯入﹐不過為了做一些識別﹐我另外在Win2008上建立一個新的憑證檔﹐該憑證的主體為”CN=WINSvrCert”。**

**[![image](images/85924-09.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_18.png)**
...
**[![image](images/85924-10.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_20.png)**
...
**cacls "C:\ProgramData\Microsoft\Crypto\RSA\MachineKeys\dd2cd8ee1b210ad4267511e7e5c4e1cf\_c45cfae7-08e7-43f7-bb26-808f90f05df6" /E /G "IIS AppPool\WCFSample":R**
...
**[![image](images/85924-11.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_22.png)**
...
**[![image](images/85924-12.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WCFwsHttpBinding_13D7D/image_24.png)**
