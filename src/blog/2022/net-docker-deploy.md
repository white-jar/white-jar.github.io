...
pubDate: 2022-09-17
description: 'docker 化時需要注意不可暴露了資料庫連線的重要資訊'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
![net-docker-deploy-01](images/net-docker-deploy-01.jpg)

appsettings.json

![net-docker-deploy-02](images/net-docker-deploy-02.jpg)
...
![net-docker-deploy-03](images/net-docker-deploy-03.jpg)

build 完後﹐來試試看是否能正確連線到 DB  
docker run -itd -p 8002:80 --name=t0 myap:0.0

實際上操作是可以連線到 DB 的﹐但是…不對啊>\_\_<﹐這樣 build 出來的 image 還是把正式環境的帳密也包進去了嗎？如果把這個image上傳了docker hub﹐就變成公開了。
...
![net-docker-deploy-04](images/net-docker-deploy-04.jpg)
...
![net-docker-deploy-05](images/net-docker-deploy-05.jpg)

現在開啟瀏覽器來試一下

![net-docker-deploy-06](images/net-docker-deploy-06.jpg)

實際操作上確實連上了資料庫﹐也避免了將資訊庫的資訊暴露在外。

![net-docker-deploy-07](images/net-docker-deploy-07.jpg)
