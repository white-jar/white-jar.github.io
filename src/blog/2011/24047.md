...
pubDate: 2011-05-02
description: 'Android 解析 XML的方式﹐使用SAX及DOM的方法。 同時以自定的Adapter來顯示資料。'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
Android 解析 XML的方式﹐使用SAX及DOM的方法。
...
[![xml_point](images/24047-01.png "xml_point")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1105/8c010a33c027_E81D/xml_point_6.png)
...
[![mail_layout2](images/24047-02.png "mail_layout2")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1105/8c010a33c027_E81D/mail_layout2_2.png)
...
這個layout很簡單﹐只有一個TextView當Title﹐還有一個ListView﹐這個ListView就是要用來顯示解析Books.xml的資料。為了這個ListView﹐需要再建一個layout檔book\_data.xml﹐這個book\_data.xml用來表示在ListView中的每一筆資料呈現方式。
...
Layout還是以圖形來看比較容易看得懂﹐在book\_data.xml的排版中每一筆資料的呈現方式第一列為書名(黃色的TextView)﹐第二列則有出版社(白色的TextView)及價錢(綠色的TextView)。

[![book_data_layout](images/24047-03.png "book_data_layout")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1105/8c010a33c027_E81D/book_data_layout_2.png)
...
[![result](images/24047-04.png "result")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1105/8c010a33c027_E81D/result_2.png)
