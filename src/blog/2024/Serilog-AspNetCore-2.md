...
pubDate: 2024-02-14
description: "Serilog.AspNetCore 的用法—將 Controller 的 Log 獨立"
author: 州・Kevin
tags:
  - Serilog
  - C#
...
builder.Services.AddControllers(); // Learn more about configuring Swagger/OpenAPI at [https://aka.ms/aspnetcore/swashbuckle](<https://aka.ms/aspnetcore/swashbuckle>)  
builder.Services.AddEndpointsApiExplorer();  
builder.Services.AddSwaggerGen(); builder.Host.UseSerilog((context, services, configuration) => configuration  
...
); var app = builder.Build(); app.UseSerilogRequestLogging(); // Configure the HTTP request pipeline.  
...
using Serilog.Core;  
using Serilog.Events;namespace Serilog.LogBranch.Extensions {  
