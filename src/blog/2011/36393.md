...
pubDate: 2011-09-16
description: '單位換算—Android & Windows Phone 7'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
| [length](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/length_4.jpg) | [Wp7_1](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/Wp7_1_4.jpg) |
...
[![android_xml](images/36393-03.png "android_xml")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/android_xml_2.png)

而在 WP7 放置的檔案﹐還必須設定『建置動作』為『Resource』。

[![wp7_xml](images/36393-04.png "wp7_xml")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/wp7_xml_2.png)
...
製作 Spinner﹐在Layout的xml中必須有Spinner元件的描述 <Spinner android:layout\_width="wrap\_content" android:id="@+id/measureSpinner" android:layout\_height="match\_parent"></Spinner>﹐
...
[![measure](images/36393-05.jpg "measure")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/measure_2.jpg)
...
[![wp7_2](images/36393-06.jpg "wp7_2")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/wp7_2_2.jpg)

**四﹑資料繫結(Data Binding)**

以顯示資料的部分來做比較

[![ListView](images/36393-07.png "ListView")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/ListView_2.png)

**Android ListView DataBindign**

1. 在Layout 中宣告 <ListView android:id="@+id/measureList" android:layout\_height="wrap\_content" android:layout\_width="match\_parent"></ListView>這樣的描述。
...
**WP7 ListBox DataBinding**

1. 撰寫Data Model  
   [![ViewModel](images/36393-08.png "ViewModel")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/ViewModel_2.png)
...
2. 在XAML上描述要引用的資料
   ...
   [![PhoneApplicationPage](images/36393-09.png "PhoneApplicationPage")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/PhoneApplicationPage_2.png)
3. 在XAML上建立資源名稱

   在**<phone:PhoneApplicationPage.Resources>**標籤中新增一個資源標籤 **<data:MeasureUnit x:Key="UnitSource"/>**  
   [![MeasureUnit](images/36393-10.png "MeasureUnit")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/MeasureUnit_2.png)
...
5. ListBox上設定資料繫結和顯示樣版
   ...
   [![MeasureList](images/36393-11.png "MeasureList")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1109/8b732000d7f6_D866/MeasureList_2.png)
