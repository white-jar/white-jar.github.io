...
pubDate: 2023-08-23
description: '原本在網路上想找一篇 Asp.net core Web Api 使用 JWT 認證﹐並且是使用 refresh token 機制的文章做參考﹐我想找的是前後端整合的﹐不過遍尋網路上的文章﹐九成以上都只講後端 Web Api 如何設計﹐極少數講前端﹐對於前後端如何配合使用更是難以找到相關文章﹐最後只找到一篇國外文章﹐具有前後端整合的文章不過前端用的是angular﹐剛好還沒時間研究但觀念差不多﹐所以就乾脆自行寫一篇前端使用 Vue 搭配 axios 如何做 refresh token 將前後端做個整合說明。'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
![net-vue-jwt-refresh-token-01](images/net-vue-jwt-refresh-token-01.jpg)
...
![net-vue-jwt-refresh-token-02](images/net-vue-jwt-refresh-token-02.gif)
...
![net-vue-jwt-refresh-token-03](images/net-vue-jwt-refresh-token-03.gif)![net-vue-jwt-refresh-token-04](images/net-vue-jwt-refresh-token-04.jpg)
...
![net-vue-jwt-refresh-token-05](images/net-vue-jwt-refresh-token-05.gif)

在執行過程約34秒左右在log中出現了 401 的錯誤﹐log 中呈現了呼叫 refreshLogin 之後又呼叫了retryOriginalRequest﹐整個過程重置了 JWT﹐從畫面上可以看到在操作者感覺不到有什麼停頓﹐仍然完成了作業。

![net-vue-jwt-refresh-token-06](images/net-vue-jwt-refresh-token-06.jpg)

而在最後到了 refreshToken 的時效也到了之後﹐畫面出現錯誤﹐在Log中出現非 401 的錯誤﹐並出現了”需要重新登入”的文字。

![net-vue-jwt-refresh-token-07](images/net-vue-jwt-refresh-token-07.jpg)
...
![net-vue-jwt-refresh-token-08](images/net-vue-jwt-refresh-token-08.jpg)![net-vue-jwt-refresh-token-09](images/net-vue-jwt-refresh-token-09.jpg)
...
![net-vue-jwt-refresh-token-10](images/net-vue-jwt-refresh-token-10.jpg)

現在可以到 terminal 下輸入以下指令npm run build:integreate 進行打包

![net-vue-jwt-refresh-token-11](images/net-vue-jwt-refresh-token-11.jpg)
...
![net-vue-jwt-refresh-token-12](images/net-vue-jwt-refresh-token-12.jpg)
