...
pubDate: 2013-01-01
description: '使用者認證的WCF服務—basicHttpBinding繫結'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
[![image](images/86462-01.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_2.png)

現在將security的mode改為Transport﹐再將組態檔做一些修改﹐以下特別標示出的地方是新加入的設定。

[![image](images/86462-02.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_4.png)

Security之下的transport的clientCredentialType屬性必須為None。而在behavior中也必須加入憑證的設定。

然後再開啟瀏覽器執行一次MyProducts.svc。

[![image](images/86462-03.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_6.png)
...
[![image](images/86462-04.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_8.png)
...
[![image](images/86462-05.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_10.png)

[![image](images/86462-06.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_12.png)
...
[![image](images/86462-07.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_14.png)

**2. IIS SSL 設定**

因為basicHttpBinding使用傳輸層加密(Transport)必須使用https﹐因此需要設定SSL。開啟IIS之後在站台使用滑鼠右鍵﹐選擇**「編輯繫結」**。

[![image](images/86462-08.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_16.png)

在站台繫結畫面上按下[新增]鍵﹐將類型選擇 **https**﹐連接埠預設為443﹐我故意另設別的port 853﹐接著在SSL憑證之處選擇所要使用的憑證。確定後就多了一個繫結設定。

[![image](images/86462-09.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_18.png)

[![image](images/86462-10.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_20.png)

上述設定完成後﹐回到IIS 畫面﹐接著點選我們的應用程式basicHttpUserAuth.webhost﹐在右側點選[SSL設定]。

[![image](images/86462-11.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_22.png)

將**[需要SSL]**的核取方塊勾選﹐然後套用﹐IIS的設定到此結束。

[![image](images/86462-12.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_24.png)
...
[![image](images/86462-13.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_26.png)
...
[![image](images/86462-14.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_28.png)
...
[![image](images/86462-15.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_30.png)
...
[![image](images/86462-16.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_32.png)

既然憑證換了﹐WCF的設定當然也要修改﹐所以WCF的組態檔web.config中的憑證要修改。

[![image](images/86462-17.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_34.png)

不過﹐這裏有另一個問題﹐如上圖﹐Server上憑證中有兩個主體名稱是相同的。這時如果使用FindPrivateKey工具要去找這個憑證檔﹐會得到在store中這個主體有多個相同名稱的錯誤。

[![image](images/86462-18.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_36.png)
...
[![image](images/86462-19.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_38.png)

將FrindPrivateKey指令改為如下即可

[![image](images/86462-20.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_40.png)

憑證檔找到後再利用calcls.exe賦予讀取憑證檔讀取的權限後﹐這時開啟IE執行WSDL https://localhost:853/basicHttpUserAuth.webhost/MyProducts.svc ﹐出現錯誤了

[![image](images/86462-21.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_42.png)

同樣是因為憑證主體名稱造成的﹐這時要修改web.config的設定﹐把對憑證搜尋的條件改為比較精準的方式﹐這裏同樣改為憑證指紋。

[![image](images/86462-22.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1301/WCF---basicHttpBinding--Java-Eclipse--AX_E5ED/image_44.png)
