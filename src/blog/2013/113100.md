...
![basicHttpSoapHeader.host](images/113100-02.png)
...
![WinClient](images/113100-04.png)
...
在這個類別裏﹐新增兩個Class﹐分別為*CustomHeader.cs*和*CustomBehaviorElement.cs*。
...
![client_wcfconfig1](images/113100-06.png)

**(3) 在行為項目延伸點【新增】**

![client_wcfconfig2](images/113100-07.png)

**在Type之處點選後﹐選擇加入的ClientHeader.dll﹐選擇型別名稱ClientHeader.CustomBehaviorElement。**

**在Name之處輸入一個自訂可以識別的名稱﹐這裏輸入ClientHeader。**

![client_wcfconfig3](images/113100-08.png)

**回到WCF編輯器可以在行為項目延伸中找到剛剛加入的項目。**

![client_wcfconfig4](images/113100-09.png)
...
![WCF編輯器](images/113100-14.png)

**點擊右側行為項目延伸畫面下方的【新增】鍵﹐會開啟一個延伸組態項目編輯器畫面。**

![WCF編輯器_1](images/113100-15.png)
...
![WCF編輯器_5](images/113100-16.png)

**按下【確定】後回到行為項目延伸畫面﹐應該可以找到剛剛所加入的新項目。**

![WCF編輯器_6](images/113100-17.png)
...
![config1](images/113100-18.png)

**下一步﹐回到組態編輯器﹐新增服務行為的行為項目延伸**

![WCF編輯器_7](images/113100-19.png)

**點選「serviceAuthorization」**

![WCF編輯器_8](images/113100-20.png)

**在serviceAuthorization下的PrincipalPermissionMode改為Custom。**

![WCF編輯器_8_1](images/113100-21.png)
...
![WinClient_test](images/113100-23.png)![WinClient_test_fiddler](images/113100-24.png)

**由Client送出的資料確實已包含了我們所相要的SoapHeader資訊。**

![WinClient_test_1](images/113100-25.png)

**而WCF也成功的回應資料。**

![WinClient_test_2](images/113100-26.png)

**若將Client程式app.config設定的密碼故意輸入錯的﹐則無法執行﹐到此WCF以SoapHeader做認證的功能已可運作。**

![WinClient_test_3](images/113100-27.png)![WinClient_test_4](images/113100-28.png)
...
![Role1](images/113100-29.png)

**接著使用testAdmin帳號測試﹐兩個方法都可以使用。**

![Role2](images/113100-30.png)
