...
pubDate: 2012-12-23
description: 'Web服務(ASMX Web Service)與WCF服務(Windows Communication Foundation Service)'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
[![image](images/85886-01.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_2.png)

[![image](images/85886-02.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_4.png)

Visual Studio 2010在建立Web服務就有一些不一樣﹐如果依上述【檔案】》【新增】》【網站】﹐會發現找不到**ASP.NET Web服務**。在VS 2010(.Net 4.0) 預設是沒有Web 服務﹐基本上微軟就是希望大家改用WCF﹐但並非Web服務不見了﹐在.Net 4.0 Web 服務已不是獨立專案方式存在﹐而是依付於一個網站專案之下。

[![image](images/85886-03.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_6.png)

因此在vs2010使用.Net Framework 4之下要使用web服務是要先建立一個ASP.NET 網站﹐然後在方案總案中再以【加入新項目】的方式﹐即可找到**Web服務**的項目﹐加入後跟過去Web服務完全一樣。

[![image](images/85886-04.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_8.png)

[![image](images/85886-05.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_10.png)

如果在vs 2010中仍想像以前建立ASP.NET Web服務的專案﹐那麼在一開始建立網站專案時﹐則要選擇.Net Framework為2.0﹑3.0或3.5﹐則在專案範本中一樣有ASP.NET Web服務專案可以選。

[![image](images/85886-06.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_12.png)

2.2 **WCF服務的建立**

Vs 2008﹑vs 2010由【檔案】à【新增】à【網站】選取WCF服務即可建立一個WCF服務的專案。

[![image](images/85886-07.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_14.png)
...
[![image](images/85886-08.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_16.png)

若是使用VS 2005的會比較麻煩一點(應該是麻煩很多點….v\_v)。
...
[![image](images/85886-09.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_18.png)

basicHttpBinding Response

[![image](images/85886-10.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_20.png)

wsHttpBinding Request

[![image](images/85886-11.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_22.png)

wsHttpBinding Response

[![image](images/85886-12.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/WebASMX-Web-ServiceWCFWindows-Communicat_CCD6/image_24.png)
