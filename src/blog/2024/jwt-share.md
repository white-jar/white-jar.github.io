...
pubDate: 2024-12-08
description: '在開發多個 Web Api 專案時, 認證/授權是必要的事, 不過在分散式開發或微服務開發時, 重複的開發登入驗證似乎也不人道, 所以一次驗證取得的 token 能夠在不同的 Web Api 中使用, 除了不用重複開發, 也是提高未來的可維護性。'
author: '州. Kevin'
image:
    url: ''
    alt: ''
tags: ['.Net', 'C#', 'JWT', 'Token', 'Web Api']
---
...
![jwt-share-01](images/jwt-share-01.jpg)
