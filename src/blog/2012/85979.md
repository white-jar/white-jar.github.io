...
pubDate: 2012-12-25
description: 'WCF 繫結模式–wsHttpBinding 之 Java 調用'
author: '州. Kevin'
image:
    url: ''
    alt: ''
...
WCF 繫結模式–wsHttpBinding 之 Java 調用
...
這裏使用的 NetBeans 版本為 NetBeans IDE 7.2 (Build 201207301726)﹐JDK 是1.6.0\_37。NetBeans可至Oracle官網(<http://netbeans.org/downloads/index.html>)下載。
...
[![image](images/85979-01.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_2.png)
...
****[![image](images/85979-02.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_4.png)****
...
****Metro 2.2.1 版可至 <http://metro.java.net/2.2.1/> 此處下載。將下載的metro-standalone-2.2.1.zip檔案解壓至自訂的路徑之下﹐例如以我個人放置到D:\Java\metro-2\_2\_1。然後開啟NetBeans﹐到工具/程式庫將 METRO 2.2.1 加入程式庫。****

****[![image](images/85979-03.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_6.png)****

****在程式庫管理器中﹐按下[加入JAR/資料夾]指向Metor 2.2.1的位置﹐之後在NetBeans 中就可以直接選擇了。****

****[![image](images/85979-04.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_8.png)****

******1.3. 建立專案******

****開啟NetBeans新增專案﹐左側選擇Java﹐右側選擇Java Application﹐[下一步]繼續。****

****[![image](images/85979-05.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_10.png)****

****輸入專案名稱﹑專案位置﹑Class檔等各項資訊﹐按下[完成]。****

****[![image](images/85979-06.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_12.png)****
...
****[![image](images/85979-07.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_14.png)****

****在Web Service Client的設定頁面上輸入WCF的URL。****

****WSDL URL：http://10.0.100.101:85/wsHttpUserAuth.webhost/MyProducts.svc?wsdl****

****[![image](images/85979-08.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_16.png)****

****完成後回到NetBeans IDE介面等一下﹐NetBeans正在產生WSDL檔及自動產生一些相關的設定檔和程式碼。NetBeans跑完後大約如下圖。****

****[![image](images/85979-09.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_18.png)****

******1.5. 檔案轉換為 UT-8 格式******

****檢視專案之下有個Generated Source﹐將其展開後會如下﹐在Generated Source是NetBeans依WSDL所自動產生的class檔。****

****[![image](images/85979-10.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_20.png)****

****點選開啟 GetProduct.java﹐畫面會出現警告﹐這是因為NetBeans自動Generated的檔案為ANSI格式﹐但這個檔案中有中文﹐而NetBeans要讀取的檔案為UTF-8﹐故這裏NetBeans跳出了警告。****

****[![image](images/85979-11.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_22.png)****
...
****[![image](images/85979-12.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_24.png)****

****開出的是Web服務屬性的畫面﹐這裏我們只要設定Quality Of Service頁籤下關於**安全**的部分。****

****[![image](images/85979-13.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_26.png)****

****在編輯Web服務屬性的設定畫面上有一個**[使用開發預設值]**的核取方塊﹐點擊一下﹐畫面會跳出一些訊息。****

****[![image](images/85979-14.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_28.png)****
...
****[![image](images/85979-15.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_30.png)****
...
****[![image](images/85979-16.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_32.png)****

****將**[認證憑證]**選擇**動態**。變更完後畫面會改變。****

****[![image](images/85979-17.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_34.png)****

****在**[****使用者名稱回呼處理程式****]**及**[****密碼回呼處理程式****]**後方的瀏覽鍵按下後選擇剛剛所建立的CallbackHandler檔案TrustStoreCallbackHandler.java。****

****接下來點選畫面上的**[信任庫]**按鍵。****

****[![image](images/85979-18.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_36.png)****

****畫面將出現**信任庫配置**的畫面。****

****[![image](images/85979-19.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_38.png)****
...
****[![image](images/85979-20.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_40.png)****
...
****[![image](images/85979-21.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_42.png)****

****接著在[程式庫]上按滑鼠右鍵選擇[Add Library…]﹐點選之前所加入的Metro 2.2.1按下[加入程式庫]就可以了。****

****[![image](images/85979-22.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_44.png)****

****[![image](images/85979-23.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_46.png)****

****[![image](images/85979-24.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_48.png)****
...
****[![image](images/85979-25.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_50.png)****
...
******[![image](images/85979-26.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_52.png)******

******[![image](images/85979-27.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_54.png)******

******下一步之後這裏要選擇所使用的容器﹐這裏選擇的是GlassFish Server 3.1.2。******

******[![image](images/85979-28.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_56.png)******

******按下[完成]後﹐可以看到所產生的專案架構。******

******[![image](images/85979-29.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_58.png)******

********2.2. 加入 Web Service Client********

******在專案名稱上滑鼠右鍵選擇New/Web Service Client。******

******[![image](images/85979-30.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_60.png)******

******選擇WSDL URL並輸入具有認證的WCF URL。******

******WSDL URL：http://10.0.100.101:85/wsHttpUserAuth.webhost/MyProducts.svc?wsdl******

******[![image](images/85979-31.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_62.png)******

******[完成]之後在專案中可以看到同樣產生了Generated Sources還有服務參照。請記得Generated出來的class檔帶有中文﹐要先將檔案格式轉換成UTF-8﹐不然在最後做builder時會失敗。******

******[![image](images/85979-32.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_64.png)******

******2.3. 編輯 Web 服務屬性******

******在Web服務參照之下的MyProducts按下滑鼠右鍵選擇[編輯Web服務屬性]。******

******[![image](images/85979-33.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_66.png)******

******到此和之前的Java Application的做法都相同﹐但這次是搭配GlassFish做container﹐因此不需要METRO﹐故接下來直接點[信任庫]設定keystore就可以。******

******[![image](images/85979-34.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_68.png)******

******將位置改選擇放置憑證的keystore檔案﹐並輸入keystore的密碼。同樣的現在是選不到別名的。請按下[OK]回到前一個畫面後也按下[OK]離開Web服務屬性的編輯。******

******[![image](images/85979-35.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_70.png)******

******重新檢視專案﹐在原始碼套件/META-INF之下多了MyProducts.svc.xml檔案。******

******[![image](images/85979-36.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_72.png)******
...
**********[![image](images/85979-37.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_74.png)**********
...
**********[![image](images/85979-38.png "image")](https://dotblogsfile.blob.core.windows.net/user/nethawk/1212/2556e9e6a4b5_13CAA/image_76.png)**********
