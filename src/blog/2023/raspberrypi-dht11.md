...
pubDate: 2023-03-13
description: '在 Raspberry Pi 上使用 .Net IoT 開發的範例真的好少﹐這次嚐試撰寫 DHT11 的實驗﹐過程上有些波折﹐不過透過 Discord 上大神的協助總算解決了問題。'
author: '州. Kevin'
image:
    url: ''
    alt: ''
tags: ['.Net', 'C#', 'DHT11', 'Raspberry pi']
---
...
![raspberrypi-dht11-01](images/raspberrypi-dht11-01.jpg)
...
![raspberrypi-dht11-02](images/raspberrypi-dht11-02.jpg)
